...
function SubmenuButton({
  ...
  return (
    <Menu.Button
      className={`ring-media-focus parent left-0 z-10 flex w-full cursor-pointer select-none items-center justify-start rounded-sm p-2.5 outline-none ring-inset data-[open]:sticky data-[open]:-top-2.5 data-[hocus]:bg-white/10 data-[open]:${
        r ? r : "bg-primary"
      } data-[focus]:ring-[3px]`}
      disabled={disabled}
    >
